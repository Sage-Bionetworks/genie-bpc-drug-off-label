...
- Mappings worthy of extra scrutiny:
  - components with interferons were changed to simply "Interferon" to match BPC.
  - Paclitaxel nanoparticle albumin-bound -> Nabpaclitaxel.  (Verified correct in meeting).
  - Trastuzumab is complex in the indications sheet.
...
vec_bpc_drugs[!(vec_bpc_drugs %in% vec_ind_drugs)]
