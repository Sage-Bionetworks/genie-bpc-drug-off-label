...
- Additional indications for non-cohort things like TMB for pembro.
...
dft_reg_num_off_label <- dft_hdrug_det %>%
  ...
  summarize(
    any_off_label = as.numeric(any(ind_exists %in% F)),
    .groups = "drop"
  )
  # ) %>%
...
gg_smooth <- ggplot(
  ...
  labs(title = "Proportion of subjects with any off label use") + 
  theme_bw() + 
  theme(
