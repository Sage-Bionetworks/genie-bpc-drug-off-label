...
png_f_3 <- tempfile(fileext = "test_plot.png")
z <- summarizor(iris, by = "Species") |>
  as_flextable(spread_first_col = TRUE) #|>
  # flextable::color(color = "gray", part = "all")
gg <- ggplot(data = iris, aes(Sepal.Length, Petal.Width)) +
  ...
  geom_point() +
  theme_minimal()
ggsave(plot = gg, filename = 'test_plot_ggsave.png', width = 7, height = 7, units = 'in')
...
Conmeds overlapping with these exposure:
