...
Among those "with" entries we haven't checked yet, `r sum(pull(dfp_unchecked, n))` are part of a exposure-indication link that is currently passing all tests.  Here's the list:
